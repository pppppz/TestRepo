...
@interface TESTestViewController ()
- (void)backgroundClicked:(id)sender;
@property (nonatomic) TESTestBackgroundShapeView *elemBackgroundShape;
@property (nonatomic) UITextField *elemField;
@property (nonatomic) CGSize visibleKeyboardSize;
@property (nonatomic) CGPoint originalScrollContentOffset;
@end

@interface TESTest_TappableBackgroundView : UIView
@property (nonatomic, weak) TESTestViewController *viewController;
@end

@implementation TESTest_TappableBackgroundView
...
@implementation TESTestViewController
...
- (void)loadView
{
    ...
    TESTest_TappableBackgroundView *rootView = [[TESTest_TappableBackgroundView alloc] initWithFrame:CGRectMake(0, 0, screenSize.width, screenSize.height)];
    ...
    TESTestBackgroundShapeView *elemBackgroundShape = [[TESTestBackgroundShapeView alloc] initWithFrame:CGRectMake(0.0, 0.0, 320.0, 568.0)];
    ...
    UITextField *elemField = [[UITextField alloc] initWithFrame:CGRectMake(0, 0, 200, 40)];
    elemField.frame = CGRectMake(38.0, 138.0, 249.2, 36.9);
    self.elemField = elemField;

    elemField.keyboardAppearance = UIKeyboardAppearanceLight;
    elemField.borderStyle = UITextBorderStyleRoundedRect;
    elemField.contentVerticalAlignment = UIControlContentVerticalAlignmentCenter;
    elemField.font = [UIFont systemFontOfSize:18.4];
    elemField.textAlignment = NSTextAlignmentLeft;
    elemField.textColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:1.0];
    [elemField addTarget:self action:@selector(hideKeyboard:) forControlEvents:UIControlEventEditingDidEndOnExit];

    [rootView addSubview:self.elemField];
...
- (void)repositionElements
{
    ...
    NSArray *layoutDescs_elemField = @[
    @[@4, [NSValue valueWithCGRect:CGRectMake(38.5, 139.5+yOff, 252.27, 37.39)], [NSValue valueWithCGPoint:CGPointMake(0.0, 119.5)]],  // iphoneclassic_portrait
    @[@6, [NSValue valueWithCGRect:CGRectMake(38.0, 138.0+yOff, 249.23, 36.94)], [NSValue valueWithCGPoint:CGPointMake(0.0, 118.0)]],  // iphone5_portrait
    @[@20, [NSValue valueWithCGRect:CGRectMake(36.0, 130.67+yOff, 236.22, 35.01)], [NSValue valueWithCGPoint:CGPointMake(0.0, 110.67)]],  // iphone6plus_portrait
    @[@16, [NSValue valueWithCGRect:CGRectMake(38.0, 137.0+yOff, 247.69, 36.71)], [NSValue valueWithCGPoint:CGPointMake(0.0, 117.0)]],  // ipad_portrait
    @[@18, [NSValue valueWithCGRect:CGRectMake(38.0, 138.0+yOff, 248.93, 36.89)], [NSValue valueWithCGPoint:CGPointMake(0.0, 118.0)]],  // iphone6_portrait
    ];
    NSDictionary *override_elemField = [_overrideElementLayoutDescriptors objectForKey:@"field"];
    if ((val = [override_elemField objectForKey:@"layoutDescs"]))
       layoutDescs_elemField = val;
    [self applyLayout:layoutDescs_elemField toView:self.elemField format:format associatedData:nil flowIsHorizontal:flowIsHoriz flowPosPtr:&flowPos];
